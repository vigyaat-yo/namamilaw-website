    ...
    <React.Fragment>
      ...
      <aside className="nm-sidebar" style={{
        ...
        <div style={{ fontSize: '.66rem', letterSpacing: '.1em', textTransform: 'uppercase',
          ...
          Mayur Vihar, New Delhi<br />contact@namamilaw.com
        </div>
      </aside>
      {open && (
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(220px,1fr))', gap: 32 }}>
        <div>
          ...
          <p style={{ fontSize: '.82rem', fontWeight: 300, lineHeight: 1.7, margin: 0 }}>
            ...
            <a href="mailto:contact@namamilaw.com" style={{ color: 'var(--color-saffron)', textDecoration: 'none' }}>contact@namamilaw.com</a>
          </p>
        </div>
        <div>
